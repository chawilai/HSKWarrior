...
const handleFlip = (index) => {
  hanzi_list.value.words[index].isFlipped = !hanzi_list.value.words[index].isFlipped;
...
<template>
  ...
  <div class="pt-3 pb-10 px-6 mx-auto max-w-screen-xl sm:px-8 md:px-12 lg:px-16 xl:px-24">
    <div class="flex flex-col justify-center items-center">
      <div class="flex justify-center items-center flex-wrap gap-3">
        ...
        >
          ...
          <i class="pi pi-eye-slash" v-if="toggle_text === 'ปิด'"></i>
      ...
      <div class="flex justify-center items-center flex-wrap gap-3">
        ...
        >
          ...
          <template v-slot:back>
            <div class="flex flex-col gap-y-2 justify-center items-center h-full w-full">
